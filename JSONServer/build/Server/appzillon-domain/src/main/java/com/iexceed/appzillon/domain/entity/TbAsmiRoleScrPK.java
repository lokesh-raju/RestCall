...
public class TbAsmiRoleScrPK implements Serializable {
    ...
    public TbAsmiRoleScrPK() {
    }

    public TbAsmiRoleScrPK(String appId, String screenId, String roleId) {
        this.appId = appId;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TbAsmiRoleScrPK)) {
            return false;
        }
        TbAsmiRoleScrPK other = (TbAsmiRoleScrPK) object;
