...
public class TbAshsRoleIntfPK implements Serializable {
    ...
    public TbAshsRoleIntfPK() {
    }

    public TbAshsRoleIntfPK(String appId, String roleId, String interfaceId) {
        this.appId = appId;
        this.roleId = roleId;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TbAshsRoleIntfPK)) {
            return false;
        }
        TbAshsRoleIntfPK other = (TbAshsRoleIntfPK) object;
