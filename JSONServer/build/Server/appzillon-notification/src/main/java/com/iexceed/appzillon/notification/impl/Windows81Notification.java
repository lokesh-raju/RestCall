 ...
 * Windows 8.1 Notification sender
 * Created on 02/03/2015
 */
public class Windows81Notification {
	private static final Logger LOG = LoggerFactory.getLoggerFactory()
			.getNotificationsLogger(ServerConstants.LOGGER_NOTIFICATION,
					Windows81Notification.class.toString());
	...
	public Map<String, String> postToWns(List<String> uris, String messageData,
		...
		LOG.info(ServerConstants.LOGGER_PREFIX_NOTIFICAITON + "................WINDOWS 8.1 Phone and  SURFACE LOGS....................");
		String accessToken = null;
		String sid = PropertyUtils.getPropValue(pAppId, ServerConstants.NOTIFICATION_WINDOWS_81_SID).toString().trim();
		String secret = PropertyUtils.getPropValue(pAppId, ServerConstants.NOTIFICATION_WINDOWS_81_SECRET_KEY).toString()
				.trim();
		...
		LOG.debug(ServerConstants.LOGGER_PREFIX_NOTIFICAITON + " XML generated for sending Windows 8.0/8.1 Phone/Surface notification is -:" + xml);
	...
	public String createMessage(String messageData, JSONObject pParams) {
		...
		if(pParams != null){
			...
			toastMessage = "<toast launch =\"" + messageData + "\"><visual><binding template=\"ToastText01\"><text id=\"1\">"
					+ messageData + "</text></binding>  </visual></toast>";
		}
		return toastMessage;
	}
